package com.lyx.web.aspect;

import com.lyx.common.exception.DescribeException;
import com.lyx.common.exception.ExceptionEnum;
import com.lyx.common.utils.DeviceUtils;
import com.lyx.common.utils.IllegalStrFilterUtils;
import com.lyx.web.exception.ExceptionHandler;
...
public class WebAspect {
    ...
    private final String pointcut = "execution(* com.lyx.web.controller.*.*(..))";
    private final String notCut = "!execution(* com.lyx.web.controller..*upload*(..))";
