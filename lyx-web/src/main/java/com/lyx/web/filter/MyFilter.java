package com.lyx.web.filter;

import com.alibaba.fastjson.JSONObject;
import com.lyx.common.cache.CacheService;
import com.lyx.common.exception.ExceptionEnum;
import com.lyx.common.utils.SignUtils;
import com.lyx.common.utils.RequestStr;
import com.lyx.common.utils.ResultUtils;
import com.lyx.sys.api.entity.UserInfo;
import com.lyx.web.constants.WebConstant;
...
public class MyFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        //校验签名
            ...
            System.out.println(SignUtils.checkSign(requestStr));
            //校验签名
            if(SignUtils.checkSign(requestStr)){
                ...
                if(isNeedToken(uri)){
                    ...
                    System.out.println(WebConstant.LOGIN_CACHE_PREFIX+token);
                    if(userInfo == null){
                        servletResponse.setContentType("application/json");
                        PrintWriter out = servletResponse.getWriter();
                        out.print(ResultUtils.exception(ExceptionEnum.LOGIN_ERROR).toString());
